  ...
  return {
    ...
    async login() {
      try {
        ...
        const res = await fetch('https://bucac.onrender.com/api', {
          method: 'POST', 
    ...
    async resetKey(id) {
      ...
      try {
        const res = await fetch(`hhttps://bucac.onrender.com/api`, {
          method: 'POST', 
          headers: {'Authorization': `Bearer ${this.token}`}
        });
    ...
    async deleteKey(id) {
      ...
      try {
        const res = await fetch(`https://bucac.onrender.com/api${id}`, {
          method: 'DELETE', 
          headers: {'Authorization': `Bearer ${this.token}`}
        });
